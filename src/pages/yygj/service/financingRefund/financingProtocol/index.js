...
class ServiceFinancingProtocol extends React.Component{
  render(){
    return(
      <div>
        <Link to="/yygj/service/financingRefund/financingProtocol">
        ...
        <div style={{width:'50%',height:'200px',marginLeft:'250px',marginTop:'100px',border:'1px black solid'}}>
          <Link to="/yygj/service/financingRefund">
...
export default ServiceFinancingProtocol
