...
import { Form, Input, Col,Row,Select, DatePicker, Button, Table, Card, message,Icon,AutoComplete  } from 'antd';
...
const mapStateToProps = (state) =>{
  ...
  const seller_organization = industrialOrderData.seller_organization;
  const buttons = industrialOrderData.buttons;
  return{
    colums, buttons, filelist, colums2, filelist2,seller_organization
  }
}
