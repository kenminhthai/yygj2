  ...
  state: {
    colums:[
      ...
      },
      {
        ...
        render:text => <a href="/yygj/industrial/orderPreserve/orderDetail">{text}</a>
      },
      {
        title: '买方机构',
    ...
    buttons:[
      ...
      {
        name:'订单发送',
        url:'/yygj/industrial/orderPreserve/sendOrder'
      },
      {
        name:'订单删除',
        url:'/yygj/industrial/orderPreserve/deleteOrder'
      },
    ],
  }
};
